error_code = {
    ...
    520: "invalid input, will{}",
    521: "buyer not receive, order id {}",
    522: "error funds, user id{}",
    523: "repeat pay, order id{}",
    524: "",
    525: "",
    526: "",
    527: "",
...
def error_invalid_input(will):
    return 520, error_code[520].format(will)


def error_buyer_not_receive(order_id):
    return 521, error_code[521].format(order_id)

def error_funds(user_id):
    return 522, error_code[522].format(user_id)

def error_repeat_pay(order_id):
